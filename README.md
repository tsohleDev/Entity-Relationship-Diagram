...
# 📖 [Entity Relationship Diagram] <a name="about-project"></a>

**Entity Relationship Diagram** is a tutorial on how to create a relational database in SQL, from a entity relationship diagram(ERD)
...
```sh
  cd my-folder
  git clone git@github.com:tsohledev/Entity-Relationship-Diagram.git
```
...
If you like this project please give us a start
